...
import { RollInteractionHandlerService } from './interaction-handlers/roll-interaction-handler/roll-interaction-handler.service'
...
import { ForceRollInteractionHandlerService } from './interaction-handlers/force-roll-interaction-handler/force-roll-interaction-handler.service'
import { ProxyRollInteractionHandlerService } from './interaction-handlers/proxy-roll-interaction-handler/proxy-roll-interaction-handler.service'
import { ManualRollInteractionHandlerService } from './interaction-handlers/manual-roll-interaction-handler/manual-roll-interaction-handler.service'
